...
def get_discount():
    ...
    """
    #### write your solution for this function below here. ####
    number_masks = int(input("Enter the number of masks you would like to order: "))
    total_cost = number_masks * 5
    if number_masks >= 5000:
        total_cost = total_cost * 0.8
    formatted_cost = "${:,.0f}".format(round(total_cost))
